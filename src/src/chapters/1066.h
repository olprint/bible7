const char* chap1066 = "And it came to pass, that seven brethren together with their mother being apprehended, to be compelled by the king to eat against the law^ swine's flesh, were tormented with whips and scourges.\n"
