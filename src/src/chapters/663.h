const char* chap663 = "Alleluia. Sing ye to our Lord a new song: let his praise be in the Church of saints.\n"
	"Let Israel be joyful in him, that made him: and let the children of Sion rejoice in their King.\n"
	"Let them praise his name in choir: on timbrel and psalter let them sing to him.\n"
	...
	"That they may do in them the judgement that is written: this glory is to all his saints. Alleluia.";