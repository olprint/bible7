const char* chap520 = "Unto the end in songs, the Psalm of David for the octave.\n"
	...
	"Let all mine enemies be ashamed, & very sore troubled: let them be converted and ashamed very quickly.";