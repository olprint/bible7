const char* chap1016 = "He is come up that shall scatter before thee, that shall keep the siege: behold the way, fortify the loins, strengthen force exceedingly.\n"
	...
	"Where is the habitation of lions, and the pasture of lions' whelps, to which the lion went, to go in thither, the lion's whelp, and is there none to make them afraid?\n"
