const char* chap719 = "O how beautiful is the chaste generation with glory! For the memory thereof is immortal: because it is known both with God and with men.\n"
