const char* chap223 = "But behold in Ephraim there arose a sedition. For they passing against the North, said to Jephte: Going to fight against the children of Ammon, why wouldst thou not call us, that we might go with thee? Therefore we will burn thy house.\n"
	...
	"they asked him: Say then Schibboleth, which is interpreted an ear of corn. Who answered, Sibboleth, not being able by the same letter to express, and ear of corn. And immediately being apprehended they killed him in the very passage of Jordan. And there fell at that time of Ephraim two and forty thousand.\n"
