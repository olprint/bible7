const char* chap819 = "Come near ye Gentiles, and hear, and ye peoples attend: let the earth hear, & the fullness thereof, the round world, and every spring thereof.\n"
	...
	"And all the host of the heavens shall melt away, and the heavens shall be folded together as a book: and all their host shall fall away as the leaf falleth from the vine, & from the fig tree.\n"
