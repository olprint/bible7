const char* chap623 = "A Psalm of David. Our Lord said to my Lord: Sit on my right hand: till I make thine enemies, the foot-stool of thy feet.\n"
	"Our Lord will send forth the rod of thy strength from Sion: rule thou in the midst of thine enemies.\n"
	"With thee the beginning in the day of thy strength: in the brightness of holy things: from the womb before the day star I begat thee.\n"
	"Our Lord sware, and it shall not repent him: Thou art a Priest for ever according to the order of Melchisedech.\n"
	"Our Lord on thy righthand hath broken kings in the day of his wrath.\n"
