const char* chap291 = "And the fury of our Lord added to be angry against Israel, & stirred up David among them saying: Go, number Israel and Juda.\n"
	...
	"Joab therefore gave the number of the description of the people to the king, and there were found of Israel eight hundred thousand strong me, that could draw sword: and of Juda five hundred thousand fighting men.\n"
